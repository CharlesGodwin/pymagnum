#!/usr/bin/env python3
#
# Copyright (c) 2023-2025 Charles Godwin <magnum@godwin.ca>
#
...
def main():
    parser = argparse.ArgumentParser(description="Magnum JSON to MySQL Generator", prog="mag2sql", fromfile_prefix_chars='@',
